#! /usr/bin/env python
"""rd_sutherlandbio.py -  specify the refractive indices"""
def rd_sutherlandbio():
    import os
    import math
    import numpy as np
    import pickle
...
# *****************
# Will read in from the sutherlandbio.dat ascii file
...
#   fdat="/ur/massie/hitran/2020/hitran_aerosol_tarfile/ascii/single_files/sutherland_khanna_biomass.dat"

    fdat="sutherland_khanna_biomass.dat"
    titlegr="Sutherland Biomass "
...
# Data: Real and imaginary refractive indices of organic-based
# nonvolatile aerosols produced by burning vegetation from
# 525 to 5000 cm-1. The mixed weed sample indices of Table 2
# from the paper by Sutherland and Khanna are tabulated here.

# Reference: Sutherland, R. A., and R. K. Khanna, Optical Properties
# of Organic-based Aerosols Produced by Burning Vegetation,
# Aerosol Science and Technology, volume 14, pgs. 331-342, 1991.

# Format: 180 lines (2x,f6.1,2x,f10.4,4x,f5.3,2x,e9.2)

#  cm-1      microns    real    imaginary
#  525.0     19.0476    1.596   0.00E+00
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_sutherlandbio: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_sutherlandbio: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_sutherlandbio: filework ")
        file_object.write(str(filework))

        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_sutherlandbio: i,wavedat,wcmdat,rndex,ridex ")
        for i in range(0,ndat):
            file_object.write("\n")
            a0="% 4d" %i
            a1="% 11.4f" %wavedat[i]
...
#   print("list5 from rd_sutherlandbio.py ",list5)
