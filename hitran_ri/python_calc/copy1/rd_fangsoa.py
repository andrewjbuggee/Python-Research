#! /usr/bin/env python
"""rd_fangsoa.py -  specify the refractive indices"""
def rd_fangsoa():
    import os
    import math
    import numpy as np
...
# Will select the jset compund to work with
    listset=['0 OHexp=0.7 day ','1 OHexp=5.5  day','2 OHexp=10.6 day']
...
# write out all possible compounds
    ...
    if iwrsp == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_fangsoa: listset ")
...
#   fdat="/ur/massie/hitran/hitran_2024/hitran_ri/ascii/single_files/fang_soa.dat"
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_fangsoa: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_fangsoa: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_fangsoa: filework ")
        file_object.write(str(filework))

        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_fangsoa: i,wavedat,wcmdat,rndex,ridex ")
        for i in range(0,ndat):
            file_object.write("\n")
            a0="% 4d" %i
            a1="% 11.4f" %wavedat[i]
...
#   print("list5 from rd_fangsoa.py ",list5)
