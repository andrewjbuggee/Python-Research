#! /usr/bin/env python
"""rd_imanaka.py -  specify the refractive indices"""
def rd_imanaka():
    import sys
    import os
    import math
...
# Will select the jset compund to work with
    listset0=['0   Imanaka tholins mmc1 ',\
    '1   Imanaka tholins mmc2',\
    '2   Imanaka tholins mmc3']

    listset=['exoplanets/imanaka_tholins_mmc1.dat',\
    'exoplanets/imanaka_tholins_mmc2.dat',\
    'exoplanets/imanaka_tholins_mmc3.dat']
...
# write out all possible files to choose from
    ...
    if iwrsp == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_imanaka: file listset ")
        for i in range(0,3):
            file_object.write("\n")
            a0=listset0[i]
            listn1=[a0]
...
# *****************
#Reference: Hiroshi Imanaka, Dale P. Cruikshank, Bishum N. Khare
#and Christopher P. McKay
#Optical constants of Titan tholins at mid-infrared wavelengths (2.5 -
#25 microns) and the possible chemical nature of Titan haze particles
#Icarus, volume 218, 247-261, 2012

#Real and Imaginary Refractive Indices of Titan tholins

#Contact:  himanaka@lpl.arizona.edu (H. Imanaka)

#Format: 7201 lines 2x,2(1x,f8.2),2(1x,f10.4)

#     cm-1    microns     real    imaginary
#   4000.000000     2.500000     1.592000     0.000781
#   3999.504150     2.500310     1.592000     0.000782
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_imanaka: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_imanaka: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_imanaka: filework ")
        file_object.write(str(filework))
        ...
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_imanaka: i,wavedat,wcmdat,rndex,ridex ")
...
#   print("list5 from rd_imanaka.py ",list5)
