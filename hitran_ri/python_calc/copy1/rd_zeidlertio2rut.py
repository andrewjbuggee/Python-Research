#! /usr/bin/env python
"""rd_zeildertio2rut.py -  specify the refractive indices"""
def rd_zeildertio2rut():
    import sys
    import os
    import math
    import numpy as np
...
# Will select the jset compund to work with
    listset0=['0   Zeidler TiO2 Rutile Ord ',\
    '1   Zeidler TiO2 Rutile Ext']

    listset=['exoplanets/zeidler_tio2_rutile_ord.dat',\
    'exoplanets/zeidler_tio2_rutile_ext.dat']
...
# write out all possible files to choose from
    ...
    if iwrsp == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_zeildertio2rut: file listset ")
        for i in range(0,2):
            file_object.write("\n")
            a0=listset0[i]
            listn1=[a0]
...
# Write out to console
    iwrsp=2
    if iwrsp == 2:
        print(" rd_zeildertio2rut: file listset ")
        for i in range(0,2):
            a0=listset0[i]
            listn1=[a0]
            print(str(listn1))
...
#Near-infrared absorptio properties of oxygen-rich stardust analogs
#The influence of coloring metal ions
#Astronomy and Astrophysics, v526, article 68, p1-10, 2011

#Real and Imaginary Refractive Indices of TiO2 Ordinary

#Contacts: Simon Zeidler (simon.zeidler@nao.ac.jp)
#          H. Mutschke (harald.mutschke@uni-jena.de)

#Format: 2126 lines 2x,2(1x,f9.2),2(1x,f10.4)

#      cm-1    microns     real    imaginary
#   21450.02      0.47     2.7770     0.0016
#   21249.47      0.47     2.7684     0.0016
#   21052.63      0.47     2.7599     0.0015
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_zeildertio2rut: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_zeildertio2rut: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_zeildertio2rut: filework ")
        file_object.write(str(filework))
        ...
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_zeildertio2rut: i,wavedat,wcmdat,rndex,ridex ")
...
#   print("list5 from rd_zeildertio2rut.py ",list5)
