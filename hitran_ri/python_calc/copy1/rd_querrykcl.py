#! /usr/bin/env python
"""rd_querrykcl.py -  specify the refractive indices"""
def rd_querrykcl():
    import os
    import math
    import numpy as np
...
# *****************
# Will read in from the querrykcl.dat ascii file
...
#   fdat="/ur/massie/hitran/2020/hitran_aerosol_tarfile/ascii/exoplanets/querry_kcl.dat"

    fdat="exoplanets/querry_kcl.dat"
    titlegr="Querry KCl "
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_querrykcl: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_querrykcl: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_querrykcl: filework ")
        ...
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_querrykcl: i,wavedat,wcmdat,rndex,ridex ")
...
#   print("list5 from rd_querrykcl.py ",list5)
