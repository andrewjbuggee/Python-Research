#! /usr/bin/env python
"""rd_clappice.py -  specify the refractive indices"""
def rd_clappice():
    import sys
    import os
    import math
...
# Will select the jset compund to work with
    listset=["ice130.clapp","ice140.clapp","ice150.clapp","ice160.clapp", \
             "ice170.clapp","ice180.clapp","ice190.clapp","ice200.clapp", \
             "ice210.clapp"]

    listset0=["0   Clapp Ice 130 K ","1   Clapp Ice 140 K ","2   Clapp Ice 150 K ", \
              "3   Clapp Ice 160 K ","4   Clapp Ice 170 K ","5   Clapp Ice 180 K ", \
              "6   Clapp Ice 190 K ","7   Clapp Ice 200 K ","8   Clapp Ice 210 K "]
...
# write out all possible files to choose from
    ...
    if iwrsp == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_clappice: file listset ")
        for i in range(0,9):
            file_object.write("\n")
            a0=listset0[i]
            listn1=[a0]
...
# Write out to console
    iwrsp=2
    if iwrsp == 2:
        print(" rd_clappice: file listset ")
        for i in range(0,9):
            a0=listset0[i]
            listn1=[a0]
            print(str(listn1))
...
# *****************
# Will read in from one of the clapp ice ascii files
    ndat=3318
...
# Data: Real and imaginary indices of water ice at 130K from
# 800 to 4004 cm-1.
...
#  800.33     12.4949  1.661   3.608E-01
#  801.29     12.4799  1.655   3.631E-01
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_clappice: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_clappice: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_clappice: filework ")
        file_object.write(str(filework))

        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_clappice: i,wavedat,wcmdat,rndex,ridex ")
        for i in range(0,ndat):
            file_object.write("\n")
            a0="% 4d" %i
            a1="% 11.4f" %wavedat[i]
...
#   print("list5 from rd_clappice.py ",list5)
