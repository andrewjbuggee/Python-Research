#! /usr/bin/env python
"""rd_jagermg2sio4.py -  specify the refractive indices"""
def rd_jagermg2sio4():
    import os
    import math
    import numpy as np
...
# *****************
# Will read in from the jagermg2sio4.dat ascii file
...
#   fdat="/ur/massie/hitran/2020/hitran_aerosol_tarfile/ascii/exoplanets/jager_mg2sio4.dat"

    fdat="exoplanets/jager_mg2sio4.dat"
    titlegr="Jager Mg2SiO4 "
...
#  51078.97656     0.19578     1.7440     0.0081
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_jagermg2sio4: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_jagermg2sio4: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_jagermg2sio4: filework ")
        ...
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_jagermg2sio4: i,wavedat,wcmdat,rndex,ridex ")
...
#   print("list5 from rd_jagermg2sio4.py ",list5)
