#! /usr/bin/env python
"""rd_alexander.py -  specify the refractive indices"""
def rd_alexander():
    import os
    import math
    import numpy as np
...
# *****************
# Will read in from the alexander.dat ascii file
...
#   fdat="/ur/massie/hitran/2020/hitran_aerosol_tarfile/ascii/single_files/alexander_brown_carbon.dat"

    fdat="alexander_brown_carbon.dat"
    titlegr="Alexander Brown Carbon "
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_alexander: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_alexander: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_alexander: filework ")
        file_object.write(str(filework))

        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_alexander: i,wavedat,wcmdat,rndex,ridex ")
        for i in range(0,ndat):
            file_object.write("\n")
            a0="% 4d" %i
            a1="% 11.4f" %wavedat[i]
...
#   print("list5 from rd_alexander.py ",list5)
