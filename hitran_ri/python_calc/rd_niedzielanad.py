#! /usr/bin/env python
"""rd_niedzielanad.py -  specify the refractive indices"""
def rd_niedzielanad():
    import os
    import math
    import numpy as np
...
# *****************
# Will read in from the niedziela_nad.dat ascii file
...
#   fdat="/ur/massie/hitran/2020/hitran_aerosol_tarfile/ascii/single_files/niedziela_nad.dat"

    fdat="niedziela_nad.dat"
    titlegr="Niedziela NAD "
...
#  704.06     14.2033  2.247  0.000E+00
#  705.99     14.1645  2.265  0.000E+00
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_niedzielanad: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_niedzielanad: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_niedzielanad: filework ")
        file_object.write(str(filework))

        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_niedzielanad: i,wavedat,wcmdat,rndex,ridex ")
        for i in range(0,ndat):
            file_object.write("\n")
            a0="% 4d" %i
            a1="% 11.4f" %wavedat[i]
...
#   print("list5 from rd_niedzielanad.py ",list5)
