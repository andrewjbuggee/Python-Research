#! /usr/bin/env python
"""rd_poschtio2.py -  specify the refractive indices"""
def rd_poschtio2():
    import sys
    import os
    import math
...
# Will select the jset compund to work with
    listset0=['0   Posch TiO2 Brookite x ',\
    '1   Posch TiO2 Brookite y ',\
    '2   Posch TiO2 Brookite z ']

    listset=['exoplanets/posch_tio2_brookite_x.dat',\
    'exoplanets/posch_tio2_brookite_y.dat',\
    'exoplanets/posch_tio2_brookite_z.dat']
...
# write out all possible files to choose from
    ...
    if iwrsp == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_poschtio2: file listset ")
        for i in range(0,3):
            file_object.write("\n")
            a0=listset0[i]
            listn1=[a0]
...
# Write out to console
    iwrsp=2
    if iwrsp == 2:
        print(" rd_poschtio2: file listset ")
        for i in range(0,3):
            a0=listset0[i]
            listn1=[a0]
            print(str(listn1))
...
#  D. Clement, J. Dorschner, 'Features of oxide dust particles in
#  circumstellar shells of AGB stars', In: Exploiting the ISO Data
#  p. 14

#  Real and Imaginary Refractive Indices of TiO2 Brookite z
...
#      5000.00      2.00     2.3542     0.0001
#      4980.08      2.01     2.3541     0.0001
#      4960.24      2.02     2.3538     0.0001
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_poschtio2: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_poschtio2: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_poschtio2: filework ")
        file_object.write(str(filework))
        ...
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_poschtio2: i,wavedat,wcmdat,rndex,ridex ")
...
#   print("list5 from rd_poschtio2.py ",list5)
