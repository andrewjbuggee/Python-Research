#! /usr/bin/env python
"""rd_henningfeo.py -  specify the refractive indices"""
def rd_henningfeo():
    import os
    import math
    import numpy as np
...
# *****************
# Will read in from the henningfeo.dat ascii file
...
#   fdat="/ur/massie/hitran/2020/hitran_aerosol_tarfile/ascii/exoplanets/henning_feo.dat"

    fdat="exoplanets/henning_feo.dat"
    titlegr="Henning FeO "
...
# *****************
#Reference: Henning, Th., B. Begemann, H. Mutschke, J. Dorschner
#Optical properties of oxide dust grains
#Astronomy and Astrophysics, Supplement Series, v112, p143-149, 1995

#Real and Imaginary Refractive Indices of FeO

#Contact: Thomas Henning (henning@mpia.de)

#Format: 77 lines 2x,2(1x,f8.2),2(1x,f10.4)

#     cm-1    microns     real    imaginary
#  50000.00     0.20     1.3830     1.1620
#  40000.00     0.25     1.7730     1.1590
#  33333.33     0.30     2.0020     1.0477
#  28571.43     0.35     2.1328     0.9471
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_henningfeo: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_henningfeo: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_henningfeo: filework ")
        file_object.write(str(filework))

        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_henningfeo: i,wavedat,wcmdat,rndex,ridex ")
        for i in range(0,ndat):
            file_object.write("\n")
            a0="% 4d" %i
            a1="% 11.4f" %wavedat[i]
...
#   print("list5 from rd_henningfeo.py ",list5)
