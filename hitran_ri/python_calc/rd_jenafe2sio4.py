#! /usr/bin/env python
"""rd_jenafe2sio4.py -  specify the refractive indices"""
def rd_jenafe2sio4():
    import os
    import math
    import numpy as np
...
# *****************
# Will read in from the jenafe2sio4.dat ascii file
...
#   fdat="/ur/massie/hitran/2020/hitran_aerosol_tarfile/ascii/exoplanets/jena_fe2sio4.dat"

    fdat="exoplanets/jena_fe2sio4.dat"
    titlegr="Jena Fe2SiO4 "
...
# *****************
#Reference: unpublished data , data stored at
#http://www.astro.uni-jena.de/Laboratory/OCDB/data/silicate
#/crystalline/fay_vis.txt
...
#  25000.00     0.40     1.8514     0.0018
#  24987.99     0.40     1.8514     0.0018
#  24975.99     0.40     1.8514     0.0018
...
# Write out results
    if nopr == 1:
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_jenafe2sio4: fileasciidir ")
        file_object.write(str(fileasciidir))
        file_object.write("\n")
        file_object.write(" rd_jenafe2sio4: fdat ")
        file_object.write(str(fdat))
        file_object.write("\n")
        file_object.write(" rd_jenafe2sio4: filework ")
        ...
        file_object.write("\n")
        file_object.write("\n")
        file_object.write(" rd_jenafe2sio4: i,wavedat,wcmdat,rndex,ridex ")
...
#   print("list5 from rd_jenafe2sio4.py ",list5)
