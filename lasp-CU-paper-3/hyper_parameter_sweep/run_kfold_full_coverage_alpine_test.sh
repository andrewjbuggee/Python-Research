...
#SBATCH --nodes=1
#SBATCH --time=01:00:00                         # K=21 sequential + importance sweep
...
#SBATCH --job-name=nn_kfold_fullcov_test
#SBATCH --output=logs/kfold_fullcov_test_%j.out
#SBATCH --error=logs/kfold_fullcov_test_%j.err
