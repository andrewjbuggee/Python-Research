...
#SBATCH --job-name=pinn_synth_M0_TEST
#SBATCH --output=logs/sweep_synth_M0_TEST_%A_%a.out
...
#   sbatch sweep_alpine_profile_only_synthetic_M0.sh
# ============================================================

echo "============================================"
echo "Variant:       M0 (geometry only, no extras)"
